...
class TestRuleConditionService:
    ...
    def test_parse_value_when_variable_is_time_type(self):
        result = self.condition_service.parse_value(RuleCondition.ORDER_TIME, 'Sat, 30 Nov 2019 18:30:00 -0300')
    ...
    def test_parse_value_when_variable_is_travel_time_type(self):
        result = self.condition_service.parse_value(RuleCondition.TRAVEL_TIME, 'Sat, 30 Nov 2019 18:30:00 -0300')
